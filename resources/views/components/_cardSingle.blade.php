<div class="col-xl-3 col-lg-4 col-md-6 card-item">
    <nav>
        <a id="{{ $id }}" class="btn btn-outline-success border-0 shadow rounded-4 w-100 text-wrap d-flex align-items-center justify-content-start p-3" type="button" onclick="javascript:window.location.href='{{ $link }}'" target="{{ $target }}">
